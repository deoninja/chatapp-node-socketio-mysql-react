...
const Header = () => {
  return (
    <header className='bg-[#e75951] text-white shadow-md'>
      <div className='max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='flex justify-between items-center py-3 sm:py-4'>
          ...
          {/* <div className='flex items-center'>
            ...
            <button className='ml-4 hidden sm:block bg-white text-[#e75951] px-3 py-1 rounded-full text-sm font-medium hover:bg-gray-100 transition'>
              Sign Out
            </button>
          </div> */}
        </div>
        ...
        {/* <div className='hidden'>
          <div className='pt-2 pb-4 space-y-1 border-t border-[#d14e47]'>
            <a
              href='#'
              className='block px-3 py-2 rounded-md hover:bg-[#d14e47]'
            >
              Home
            </a>
            <a
